...
void case_1() {
    puts("\n----------SA_SIGINFO----------");//this flag makes handler take 3 args insted of 1 and provide with strict siginfo_t which contains a fuckload of information
...
void case_2() {
    ...
    puts("\n\nHandler to SIGCHLD wasn't call when SIGSTOP was sent second time");
}
